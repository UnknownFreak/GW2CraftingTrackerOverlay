...
namespace GW2APIComponent.GW2Components.Strings
{
    public static class IconStrings
    {
        public static Dictionary<string, string> crafting = new Dictionary<string,string>()
        {   { "Mystic Forge"    , "http://wiki.guildwars2.com/images/thumb/6/6f/Mystic_Forge.png/20px-Mystic_Forge.png" },
